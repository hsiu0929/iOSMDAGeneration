...
public class UITestsSwift
{
    private static final char[] OutputStreamWriter = null;

	public UITestsSwift(String templateFile, String Location, String FileName, String projectName)
    {
        try
        {
            /*
           ...
           /* File ViewController = new File("ViewController.swift");
            ...
            FileOutputStream Swift = new FileOutputStream(Location + FileName);
            
            BufferedWriter writer = new BufferedWriter(
                new OutputStreamWriter(Swift));
