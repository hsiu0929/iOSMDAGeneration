...
public class ContentsXcworkspaceData
{
    private static final char[] OutputStreamWriter = null;

	public ContentsXcworkspaceData(String templateFile, String Location, String FileName, String projectName)
    {
        try
        {
            /*
           ...
           /* File ViewController = new File("ViewController.swift");
            ...
            FileOutputStream Contents = new FileOutputStream(Location + FileName);
            
            BufferedWriter writer = new BufferedWriter(
                new OutputStreamWriter(Contents));
