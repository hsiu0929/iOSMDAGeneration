...
public class AppIconContestsJson
{
    private static final char[] OutputStreamWriter = null;

	public AppIconContestsJson(String templateFile, String Location, String FileName)
    {
        try
        {
            /*
           ...
           /* File ViewController = new File("ViewController.swift");
            ...
            FileOutputStream ContentsJson = new FileOutputStream(Location + FileName);
            
            BufferedWriter writer = new BufferedWriter(
                new OutputStreamWriter(ContentsJson));
