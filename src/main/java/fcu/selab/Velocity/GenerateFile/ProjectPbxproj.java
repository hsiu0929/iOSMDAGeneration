...
public class ProjectPbxproj
{
    private static final char[] OutputStreamWriter = null;

	public ProjectPbxproj(String templateFile, String Location, String FileName, String projectName)
    {
        try
        {
            /*
           ...
           /* File ViewController = new File("ViewController.swift");
            ...
            FileOutputStream Pbxproj = new FileOutputStream(Location + FileName);
            
            BufferedWriter writer = new BufferedWriter(
                new OutputStreamWriter(Pbxproj));
