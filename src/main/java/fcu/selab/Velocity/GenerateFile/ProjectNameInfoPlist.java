...
public class ProjectNameInfoPlist
{
    private static final char[] OutputStreamWriter = null;

	public ProjectNameInfoPlist(String templateFile, String Location, String FileName)
    {
        try
        {
            /*
           ...
           /* File ViewController = new File("ViewController.swift");
            ...
            FileOutputStream InfoPlist = new FileOutputStream(Location + FileName);
            
            BufferedWriter writer = new BufferedWriter(
                new OutputStreamWriter(InfoPlist));
