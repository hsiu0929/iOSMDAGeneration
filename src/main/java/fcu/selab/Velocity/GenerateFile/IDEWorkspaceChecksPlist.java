...
public class IDEWorkspaceChecksPlist
{
    private static final char[] OutputStreamWriter = null;

	public IDEWorkspaceChecksPlist(String templateFile, String Location, String FileName)
    {
        try
        {
            /*
           ...
           /* File ViewController = new File("ViewController.swift");
            ...
            FileOutputStream IDEWorkspaceChecks = new FileOutputStream(Location + FileName);
            
            BufferedWriter writer = new BufferedWriter(
                new OutputStreamWriter(IDEWorkspaceChecks));
