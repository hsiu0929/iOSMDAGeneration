...
public class ViewControllerSwift
{
    private static final char[] OutputStreamWriter = null;

	public ViewControllerSwift(String templateFile, String Location, String FileName, String projectName)
    {
        try
        {
            /*
           ...
           /* File ViewController = new File("ViewController.swift");
            ...
            FileOutputStream ViewController = new FileOutputStream(Location + FileName);
            
            BufferedWriter writer = new BufferedWriter(
                new OutputStreamWriter(ViewController));
