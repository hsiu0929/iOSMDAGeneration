...
public class LaunchScreenStoryboard
{
    private static final char[] OutputStreamWriter = null;

	public LaunchScreenStoryboard(String templateFile, String Location, String FileName)
    {
        try
        {
            /*
           ...
           /* File ViewController = new File("ViewController.swift");
            ...
            FileOutputStream LaunchScreen = new FileOutputStream(Location + FileName);
            
            BufferedWriter writer = new BufferedWriter(
                new OutputStreamWriter(LaunchScreen));
